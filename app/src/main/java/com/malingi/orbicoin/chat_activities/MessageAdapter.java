...
public class MessageAdapter extends ArrayAdapter<MessageFormat> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        Log.i(Group_ChatActivity.TAG, "getView:");
        ...
        if(TextUtils.isEmpty(message.getMessage())){
            ...
            Log.i(Group_ChatActivity.TAG, "getView: is empty ");
            String userConnected = message.getUsername();
            messageText.setText(userConnected);

        }else if(message.getUniqueId().equals(Group_ChatActivity.uniqueId)){
            Log.i(Group_ChatActivity.TAG, "getView: " + message.getUniqueId() + " " + Group_ChatActivity.uniqueId);
            ...
            Log.i(Group_ChatActivity.TAG, "getView: is not empty");
